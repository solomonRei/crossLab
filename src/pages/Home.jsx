...
const features = [
  {
    ...
    description: "Connect with talented students from different disciplines to create powerful cross-functional teams",
  ...
  },
  {
    ...
    description: "Get personalized guidance and support tailored to your role, whether you're developing, designing, or analyzing",
  ...
  },
  {
    ...
    description: "Receive constructive feedback from peers and mentors to continuously improve your skills and projects",
  ...
  },
  {
    ...
    description: "Present your completed projects to potential employers and build an impressive portfolio",
...
const testimonials = [
  {
    ...
    role: "UX Designer",
    company: "Google",
    avatar: "https://images.unsplash.com/photo-1494790108755-2616b612b277?w=64&h=64&fit=crop&crop=face",
    quote: "CrossLab taught me how to work with developers and analysts. Now I'm leading cross-functional teams at Google."
  },
  {
    ...
    quote: "The collaborative projects here prepared me for real-world challenges. Got hired 2 weeks after graduation!"
  },
  {
    name: "Emily Watson",
    role: "Data Scientist", 
    ...
    quote: "Working with designers and business students gave me perspectives I never had. It changed everything."
  }
]
    ...
    <div className="relative overflow-hidden">
      ...
      <section className="relative container mx-auto px-4 py-20 lg:py-32">
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <Badge variant="secondary" className="mb-8 px-6 py-2 text-sm font-medium bg-gradient-to-r from-blue-50 to-purple-50 text-blue-700 border border-blue-200/50 shadow-sm">
              ✨ Trusted by 1,200+ students from top universities
            </Badge>
            
            <h1 className="text-5xl lg:text-7xl font-bold mb-8 leading-tight">
              <span className="block text-gray-900 mb-2">Build real projects</span>
            ...
            <p className="text-xl lg:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Join cross-disciplinary teams of designers, developers, analysts, and business minds. 
              Solve real challenges. Build your portfolio. Land your dream job.
            </p>
      ...
      <section className="relative container mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {disciplines.map((discipline, index) => (
            ...
            >
              <Card className={`relative p-8 ${discipline.bgColor} border-0 shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-2 overflow-hidden`}>
                {/* Gradient overlay on hover */}
                <div className={`absolute inset-0 bg-gradient-to-br ${discipline.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300`}></div>
                
                <CardContent className="p-0 relative z-10">
                  <div className={`w-16 h-16 bg-gradient-to-br ${discipline.color} rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                    <discipline.icon className="h-8 w-8 text-white" />
                  </div>
                  
                  <h3 className="text-2xl font-bold mb-3 text-gray-900">{discipline.title}</h3>
                  <p className="text-gray-600 mb-4 text-sm leading-relaxed">{discipline.description}</p>
                  
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-500">{discipline.students}</span>
                    <div className="flex -space-x-2">
                      {[1,2,3].map(i => (
                        <div key={i} className="w-8 h-8 bg-gradient-to-br from-gray-200 to-gray-300 rounded-full border-2 border-white"></div>
                      ))}
                    </div>
                  </div>
                </CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From intelligent team matching to professional mentorship, 
              we provide all the tools and support for your success
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group"
              >
                <Card className={`p-10 h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-500 ${feature.bgColor} group-hover:-translate-y-1 bg-white/80 backdrop-blur-sm`}>
                  <CardContent className="p-0">
                    <div className={`w-16 h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mb-8 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { 
                ...
                description: "Tell us about your skills, interests, and what you want to learn",
                icon: Target,
              ...
              { 
                step: "02", 
                title: "Get Matched", 
                description: "Our AI connects you with the perfect cross-functional team",
                icon: Users,
              ...
              { 
                step: "03", 
                title: "Build & Learn", 
                description: "Work on real projects with mentorship and peer support",
                icon: Zap,
              ...
              { 
                ...
                description: "Present your project and add it to your professional portfolio",
                icon: Award,
              ...
              >
                <div className={`w-20 h-20 bg-gradient-to-br ${step.color} rounded-3xl flex items-center justify-center mb-6 mx-auto shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  <step.icon className="h-10 w-10 text-white" />
                </div>
                
                <div className="text-sm font-bold text-gray-400 mb-2 tracking-wide">{step.step}</div>
